...
function App() {
  ...
  return (
    <div className='App bg-bkg text-white selection:bg-accent selection:text-bkg'>
      <div id='parallax'>
        <nav
        ...
        <header className='min-h-screen flex flex-col justify-evenly items-center relative'>
          ...
          <a href={header.heroUrl} className="bg-accent text-bkg font-medium py-3 px-8 rounded-full border border-bkg focus:outline-none z-10 focus-visible:ring-4 ring-accent ring-offset-bkg ring-offset-2 hover:bg-accent/90 flex space-x-2 drop-shadow-text-lg hover:drop-shadow-none transition-shadow items-center">
        ...
        <main className="relative mt-16 sm:mt-24 lg:mt-40 pb-16 -mb-16 grid gap-16 sm:gap-24 lg:gap-40 overflow-hidden">
          <section aria-labelledby="headline" class="container grid gap-4 text-center max-w-prose">
            <div>
              <small className="tracking-widest text-accent uppercase drop-shadow-text-sm">{main.smallIntro}</small>
              <h2 id="headline" className="text-3xl font-bold tracking-wide drop-shadow-md">{main.headlineIntro}</h2>
            </div>
