          ...
          <div className="container flex flex-wrap md:justify-between items-center md:items-start gap-12">
            <div className="grid gap-2 grow justify-items-center md:justify-items-start basis-full md:basis-1/4">
              ...
              <p className="text-muted text-sm text-center md:text-left">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae quos repudiandae voluptatum et autem omnis quam quisquam quia qui doloremque.
              </p>
            </div>
            <nav 
            ...
            >
              <div className="grid gap-3">
                ...
                <ul aria-label="About Traverse">
                  <li>
                    <a href="#" className='hover:text-accent transition-colors focus:outline-none focus-visible:ring-4 ring-offset-2 ring-offset-bkg px-2 ring-accent rounded-full'>About Us</a>
                  </li>
                  <li>
                    <a href="#" className='hover:text-accent transition-colors focus:outline-none focus-visible:ring-4 ring-offset-2 ring-offset-bkg px-2 ring-accent rounded-full'>Press</a>
                  </li>
                  <li>
                    <a href="#" className='hover:text-accent transition-colors focus:outline-none focus-visible:ring-4 ring-offset-2 ring-offset-bkg px-2 ring-accent rounded-full'>News</a>
                  </li>
                </ul>
                <div className="grid gap-3">
                ...
                <ul aria-label="About Traverse">
                  <li>
                    <a href="#" className='hover:text-accent transition-colors focus:outline-none focus-visible:ring-4 ring-offset-2 ring-offset-bkg px-2 ring-accent rounded-full'>Johannesburg</a>
                  </li>
                  <li>
                    <a href="#" className='hover:text-accent transition-colors focus:outline-none focus-visible:ring-4 ring-offset-2 ring-offset-bkg px-2 ring-accent rounded-full'>Amsterdam</a>
                  </li>
                  <li>
                    <a href="#" className='hover:text-accent transition-colors focus:outline-none focus-visible:ring-4 ring-offset-2 ring-offset-bkg px-2 ring-accent rounded-full'>New York</a>
                  </li>
                  <li>
                    <a href="#" className='hover:text-accent transition-colors focus:outline-none focus-visible:ring-4 ring-offset-2 ring-offset-bkg px-2 ring-accent rounded-full'>Brazil</a>
                  </li>
                  <li>
                    <a href="#" className='hover:text-accent transition-colors focus:outline-none focus-visible:ring-4 ring-offset-2 ring-offset-bkg px-2 ring-accent rounded-full'>Sydney</a>
                  </li>
                </ul>
                </div>
                <div className="grid gap-3">
                ...
                <ul aria-label="About Traverse">
                  <li>
                    <a href="#" className='hover:text-accent transition-colors focus:outline-none focus-visible:ring-4 ring-offset-2 ring-offset-bkg px-2 ring-accent rounded-full'>Email</a>
                  </li>
                  <li>
                    <a href="#" className='hover:text-accent transition-colors focus:outline-none focus-visible:ring-4 ring-offset-2 ring-offset-bkg px-2 ring-accent rounded-full'>Facebook</a>
                  </li>
                  <li>
                    <a href="#" className='hover:text-accent transition-colors focus:outline-none focus-visible:ring-4 ring-offset-2 ring-offset-bkg px-2 ring-accent rounded-full'>Instagram</a>
                  </li>
                </ul>
                </div>
              </div>
