      ...
      <div className='h-screen pb-12 sm:pb-0 overflow-y-auto overflow-x-hidden relative scroll-smooth perspective' >
        ...
        <main className='relative mt-16 pt-16 sm:mt-24 lg:mt-40 pb-16'>
          ...
          <section
            ...
            className='mt-10 sm:mt-20 lg:mt-32 container xs:w-screen fade-up'
          >
            <Swiper
              slidesPerView={1}
              spaceBetween={10}
          ...
          <section aria-labelledby='map' className='container flex flex-wrap md:space-x-16 space-y-12 md:space-y-0 justify-between items-center fade-up'>
